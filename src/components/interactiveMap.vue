<template>
  <section class="px-6 sm:px-10 md:px-16 py-5 md:py-10 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
    <div class="w-full md:w-[70%] flex justify-center"  data-aos="zoom-in" 
      data-aos-delay="400"
      data-aos-duration="800">
      <svg
        baseProfile="tiny"
        class="w-[95%] sm:w-[90%] md:w-full h-auto max-w-[800px]"
        fill="#008000"
        stroke="#ffffff"
      ...
      >
        <g id="features">
          <path
            ...
            id="NGKE"
            name="Kebbi"
            class="fill-[green] hover:fill-green-600 cursor-pointer transition-all"
            @click="showInfo('Kebbi')"
          />
          <path
        ...
        <g id="label_points" font-family="Arial, sans-serif" text-anchor="middle">
          <text x="151.4" y="220.1" class="state-label">Kebbi</text>
          <text x="265.2" y="349.4" class="state-label">Niger</text>
          <text x="209.5" y="444.7" class="state-label">Kwara</text>
          <text x="94.4" y="565.6" class="state-label">Ogun</text>
          <text x="111" y="478.1" class="state-label">Oyo</text>
          <text x="92.4" y="601.9" class="state-label">Lagos</text>
          <text x="848.9" y="184.8" class="state-label">Borno</text>
          <text x="777.8" y="379.7" class="state-label">Adamawa</text>
          <text x="647" y="493.6" class="state-label">Taraba</text>
          <text x="508.1" y="536.6" class="state-label">Benue</text>
          <text x="478.9" y="675" class="state-label">Cross River</text>
          <text x="252.5" y="91.8" class="state-label">Sokoto</text>
          <text x="322.9" y="171.6" class="state-label">Zamfara</text>
          <text x="716.6" y="148.9" class="state-label">Yobe</text>
          <text x="415.7" y="131.8" class="state-label">Katsina</text>
          <text x="574.6" y="158.3" class="state-label">Jigawa</text>
          <text x="208.5" y="582.6" class="state-label">Ondo</text>
          <text x="293.6" y="685.3" class="state-label">Delta</text>
          <text x="300.6" y="737.3" class="state-label">Bayelsa</text>
          <text x="369" y="722.5" class="state-label">Rivers</text>
          <text x="434.8" y="729.3" class="state-label">Akwa Ibom</text>
          <text x="411.6" y="685.9" class="state-label">Abia</text>
          <text x="449.3" y="623.3" class="state-label">Ebonyi</text>
          <text x="370.6" y="635" class="state-label">Anambra</text>
          <text x="311.9" y="584.1" class="state-label">Edo</text>
          <text x="578.7" y="306.7" class="state-label">Bauchi</text>
          <text x="571.8" y="414.7" class="state-label">Plateau</text>
          <text x="455.2" y="452.4" class="state-label">Nassarawa</text>
          <text x="694" y="306.9" class="state-label">Gombe</text>
          <text x="402.9" y="604.5" class="state-label">Enugu</text>
          <text x="327.8" y="499.9" class="state-label">Kogi</text>
          <text x="187.5" y="528.6" class="state-label">Osun</text>
          <text x="377" y="680.9" class="state-label">Imo</text>
          <text x="245.6" y="514" class="state-label">Ekiti</text>
          <text x="433.4" y="299.4" class="state-label">Kaduna</text>
          <text x="489" y="201.6" class="state-label">Kano</text>
          <text x="383.6" y="431.5" class="state-label">FCT</text>
        </g>
      </svg>
    </div>

     <div class="w-full md:w-[30%] text-center md:text-left space-y-5">
      <h2 class="text-3xl sm:text-5xl font-bold text-gray-800"  data-aos="fade-up"
      data-aos-duration="800">
       <span class="text-[green]">Interactive</span> Map of Nigeria
      </h2>
      <p class="text-gray-600 leading-relaxed" data-aos="fade-up" data-aos-duration="1000">
        Explore Nigeria interactively using the map. Click on any state to see more information about the state.
      </p>
      <router-link
        to="/"
        class="inline-block bg-[green] hover:bg-green-700 text-white font-medium px-6 py-3 rounded-lg transition-all duration-300"
...
function showInfo(state) {
  alert(`you clicked on ${state} state`);
}
</script>
...
.state-label {
  ...
  font-size: 12px;
  font-weight: 600;
  text-shadow: 0 1px 3px rgba(0, 0, 0, 0.8); /* adds dark contrast */
  pointer-events: none;
  user-select: none;
}
